...
public:
    ...
    */
    ...
    /*
        位置控制模式，默认相对模式
    */
    EMMC423V53_Command_Status Location_Mode_Cmd(uint8_t direction,uint32_t speed, uint32_t location, uint8_t acceleration = 0x00, bool loaction_mode = false, bool dual_machine = true)
    {
