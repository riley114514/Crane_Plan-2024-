...
public:
    ...
    void Gripper_Start_To_Pick(int target_locatoin)
    {
        ...
        this->Gripper_Set_Y_Location(1755);
    }
    ...
    void Gripper_Start_To_Set(int target_location)
    {
        ...
        if(target_location == 1000)
            this->Gripper_Set_Z_Location(110,30);//放置速度需要改动
        else
...
void Task_Get_Location(void *prfrk)
{
    ...
    while (1)
    {
        ...
        // 暂定，需要看是左侧还是右侧电机去区别
        gripper->Current_Y_Location = 1840.0 + gripper->Steeping42_Motor_1->Now_Location / 65536 * Trip_mm;
