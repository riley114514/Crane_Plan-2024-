...
#define Max_Wait_Time 10 //最大等待时间: ms
#define Once_Circle_Pulse 3200 //电机转一圈的脉冲
#define PI 3.1415926535
#define Max_Speed 2000 //最大速度: rpm/min
...
public:
    ...
    */
    ...
    Steeping42_Command_Status Steeping_Init(HardwareSerial *serial, uint8_t id, int rx, int tx)
    {
        if (id < 1 || id > 255 || serial == NULL)
            return Command_Error;
        this->Steeping_Serial = serial;
    ...
    */
    ...
    /*
        速度控制模式
    */
    Steeping42_Command_Status Speed_Mode_Cmd(uint8_t direction, uint16_t speed, uint8_t acceleration, bool dual_machine = true)
    {
    ...
    */
    Steeping42_Command_Status Back_To_Zero_Location(uint8_t zero_mode = 0x02, bool dual_machine = false)
    {
        uint8_t machine_flag = dual_machine ? 0x01 : 0x00;
    ...
    */
    ...
    /*
        修改电机的回零的参数
    */
    Steeping42_Command_Status Change_Zero_Parameter(uint16_t speed, uint8_t zero_mode = 0x02, uint8_t direction = 0x00, uint8_t store = 0x01)
    {
    ...
    */
    ...
    /*
        读取电机的参数
    */
    Steeping42_Command_Status Read_Motor_Info(void)
    {
    ...
    Steeping42_Command_Status Reload_Current(void)
    {
